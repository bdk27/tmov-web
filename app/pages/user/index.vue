  ...
  <div class="min-h-full py-12 md:px-4 px-6 lg:px-8">
    ...
    <div class="max-w-4xl mx-auto space-y-8">
      ...
      >
        ...
        >
          <!-- 左側：頭像與身分標籤 (固定寬度，居中對齊) -->
          <div class="w-full md:w-48 flex flex-col items-center gap-4 shrink-0">
            <div class="relative">
              <!-- 載入中 -->
              <USkeleton
                v-if="isLoading"
            ...
            <div v-if="!isLoading" class="flex flex-col items-center">
              ...
              >
                {{
                  authStore.user?.role === "ROLE_ADMIN" ? "管理員" : "一般會員"
                }}
              </UBadge>
            </div>
          </div>
          ...
          <div class="flex-1 w-full min-w-0">
            ...
            <div class="mb-6 text-center md:text-left">
              <USkeleton
                v-if="isLoading"
                class="h-5 w-48 mb-2 mx-auto md:mx-0"
              />
              <h2
                v-else
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <!-- 生日 -->
              <div class="group flex items-center gap-3">
                <UIcon name="i-heroicons-cake" class="w-5 h-5 text-gray-500" />
              ...
              <div class="group flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <USkeleton v-if="isLoading" class="h-3 w-full" />
                  <p
                    v-else
                    class="text-gray-900 dark:text-white font-medium truncate"
                  >
